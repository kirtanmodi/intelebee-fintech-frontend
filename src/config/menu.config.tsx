...
export const MENU_SIDEBAR: TMenuConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: 'Approve WorkLog',
        path: '/approve-worklog'
      },
      {
        title: 'WorkLog Reports',
        path: '/worklog-report'
      },
      {
        title: 'Admin Rejected WorkLog Report',
        path: '/admin-rejected-worklog-report'
      },
      {
        title: 'Admin Approved WorkLog Report',
        path: '/admin-approved-worklog-report'
      }
    ]
  },
  {
